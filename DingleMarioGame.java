...
press enter for all options i.e. select diffculty and to replay or not
...
3.autoshoot function implemented (if u do not fire within 7 seconds, ball will automatically shoot)
    -a bombomb animation will flash and explode if tiemr runs out
...
public class DingleMarioGame extends Applet implements Runnable, ActionListener
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 9121229062153180937L;
