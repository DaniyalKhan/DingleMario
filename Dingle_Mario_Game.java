...
public class Dingle_Mario_Game extends Applet implements Runnable, ActionListener
{
	...
	GAME_PICS [0] [0] = getImage (base, "front page.png");
	GAME_PICS [1] [0] = getImage (base, "start.png");
	GAME_PICS [2] [0] = getImage (base, "controls.png");
	GAME_PICS [3] [0] = getImage (base, "highscore.png");
	GAME_PICS [4] [0] = getImage (base, "instructions.png");
	GAME_PICS [5] [0] = getImage (base, "quit.png");
	GAME_PICS [6] [0] = getImage (base, "next.png");
	GAME_PICS [7] [0] = getImage (base, "back.png");
	GAME_PICS [8] [0] = getImage (base, "town.png");
	GAME_PICS [9] [0] = getImage (base, "arrow.png");
	GAME_PICS [10] [0] = getImage (base, "arrowright.png");
	GAME_PICS [11] [0] = getImage (base, "arrowleft.png");
	GAME_PICS [12] [0] = getImage (base, "shell.png");
	GAME_PICS [13] [0] = getImage (base, "mushroom.png");
	GAME_PICS [14] [0] = getImage (base, "fireball.png");
	GAME_PICS [15] [0] = getImage (base, "arrowup.png");
	GAME_PICS [16] [0] = getImage (base, "blueball2.png");
	GAME_PICS [17] [0] = getImage (base, "redball.png");
	GAME_PICS [18] [0] = getImage (base, "greenball.png");
	GAME_PICS [19] [0] = getImage (base, "shellitem.png");
	GAME_PICS [20] [0] = getImage (base, "mushroomitem.png");
	GAME_PICS [21] [0] = getImage (base, "firefloweritem.png");
	GAME_PICS [22] [0] = getImage (base, "arrowup2.png");
	GAME_PICS [23] [0] = getImage (base, "credits.png");
	GAME_PICS [24] [0] = getImage (base, "intro.png");
	GAME_PICS [25] [0] = getImage (base, "toadtown.png");
	GAME_PICS [26] [0] = getImage (base, "hand.png");
	GAME_PICS [27] [0] = getImage (base, "normal music.png");
	GAME_PICS [28] [0] = getImage (base, "epic music.png");
	GAME_PICS [29] [0] = getImage (base, "castle.png");
	GAME_PICS [30] [0] = getImage (base, "dooropen.png");
	GAME_PICS [31] [0] = getImage (base, "dooropen1.png");
	GAME_PICS [32] [0] = getImage (base, "dooropen2.png");
	GAME_PICS [33] [0] = getImage (base, "dooropen3.png");
	GAME_PICS [34] [0] = getImage (base, "monster1.png");
	GAME_PICS [35] [0] = getImage (base, "monster2.png");
	GAME_PICS [36] [0] = getImage (base, "monster3.png");
	GAME_PICS [37] [0] = getImage (base, "monster4.png");
	GAME_PICS [38] [0] = getImage (base, "monster5.png");
	GAME_PICS [39] [0] = getImage (base, "monster6.png");
	GAME_PICS [40] [0] = getImage (base, "arrowdown.png");
	GAME_PICS [41] [0] = getImage (base, "cancel.png");
	GAME_PICS [42] [0] = getImage (base, "currentball.png");
	GAME_PICS [43] [0] = getImage (base, "next ball.png");
	GAME_PICS [44] [0] = getImage (base, "score.png");
	GAME_PICS [45] [0] = getImage (base, "turn.png");
	GAME_PICS [46] [0] = getImage (base, "DingleMarioGameScreen.png");
	GAME_PICS [47] [0] = getImage (base, "paused.png");
	GAME_PICS [48] [0] = getImage (base, "insane.png");
	GAME_PICS [49] [0] = getImage (base, "hard.png");
	GAME_PICS [50] [0] = getImage (base, "medium.png");
	GAME_PICS [51] [0] = getImage (base, "easy.png");
	GAME_PICS [52] [0] = getImage (base, "greybackground.png");
	GAME_PICS [53] [0] = getImage (base, "yes.png");
	GAME_PICS [54] [0] = getImage (base, "no.png");
	GAME_PICS [55] [0] = getImage (base, "youlose.png");
	GAME_PICS [56] [0] = getImage (base, "youwin.png");
	GAME_PICS [57] [0] = getImage (base, "DingleMarioGameScreen2.png");
	GAME_PICS [58] [0] = getImage (base, "DingleMarioGameScreen3.png");
	GAME_PICS [59] [0] = getImage (base, "DingleMarioGameScreen4.png");
	GAME_PICS [60] [0] = getImage (base, "mariostar.png");
	GAME_PICS [61] [0] = getImage (base, "marioidle.png");
	GAME_PICS [62] [0] = getImage (base, "new highscore.png");

	GAME_PICS [0] [1] = getImage (base, "Mwalk1.png");
	GAME_PICS [1] [1] = getImage (base, "Mwalk2.png");
	GAME_PICS [2] [1] = getImage (base, "Mwalk3.png");
	GAME_PICS [3] [1] = getImage (base, "Mwalk4.png");
	GAME_PICS [4] [1] = getImage (base, "Mwalk5.png");
	GAME_PICS [5] [1] = getImage (base, "Mwalk4.png");
	GAME_PICS [6] [1] = getImage (base, "Mwalk3.png");
	GAME_PICS [7] [1] = getImage (base, "Mwalk2.png");

	GAME_PICS [0] [2] = getImage (base, "Ldance1.png");
	GAME_PICS [1] [2] = getImage (base, "Ldance2.png");
	GAME_PICS [2] [2] = getImage (base, "Ldance3.png");
	GAME_PICS [3] [2] = getImage (base, "Ldance4.png");
	GAME_PICS [4] [2] = getImage (base, "Ldance5.png");
	GAME_PICS [5] [2] = getImage (base, "Ldance7.png");
	GAME_PICS [6] [2] = getImage (base, "Ldance8.png");
	GAME_PICS [7] [2] = getImage (base, "Ldance9.png");
	GAME_PICS [8] [2] = getImage (base, "Ldance10.png");
	GAME_PICS [9] [2] = getImage (base, "Ldance11.png");
	GAME_PICS [10] [2] = getImage (base, "Ldance12.png");
	GAME_PICS [11] [2] = getImage (base, "Ldance13.png");
	GAME_PICS [12] [2] = getImage (base, "Ldance14.png");
	GAME_PICS [13] [2] = getImage (base, "Ldance15.png");

	GAME_PICS [0] [3] = getImage (base, "Bbutton1.png");
	GAME_PICS [1] [3] = getImage (base, "Bbutton1.png");
	GAME_PICS [2] [3] = getImage (base, "Bbutton2.png");
	GAME_PICS [3] [3] = getImage (base, "Bbutton2.png");
	GAME_PICS [4] [3] = getImage (base, "Bbutton3.png");
	GAME_PICS [5] [3] = getImage (base, "Bbutton3.png");
	GAME_PICS [6] [3] = getImage (base, "Bbutton2.png");
	GAME_PICS [7] [3] = getImage (base, "Bbutton2.png");

	GAME_PICS [0] [4] = getImage (base, "Abutton1.png");
	GAME_PICS [1] [4] = getImage (base, "Abutton1.png");
	GAME_PICS [2] [4] = getImage (base, "Abutton2.png");
	GAME_PICS [3] [4] = getImage (base, "Abutton2.png");
	GAME_PICS [4] [4] = getImage (base, "Abutton3.png");
	GAME_PICS [5] [4] = getImage (base, "Abutton3.png");
	GAME_PICS [6] [4] = getImage (base, "Abutton2.png");
	GAME_PICS [7] [4] = getImage (base, "Abutton2.png");

	GAME_PICS [0] [5] = getImage (base, "1.png");
	GAME_PICS [1] [5] = getImage (base, "2.png");
	GAME_PICS [2] [5] = getImage (base, "3.png");
	GAME_PICS [3] [5] = getImage (base, "4.png");
	GAME_PICS [4] [5] = getImage (base, "5.png");
	GAME_PICS [5] [5] = getImage (base, "6.png");
	GAME_PICS [6] [5] = getImage (base, "7.png");
	GAME_PICS [7] [5] = getImage (base, "8.png");
	GAME_PICS [8] [5] = getImage (base, "9.png");
	GAME_PICS [9] [5] = getImage (base, "10.png");
	GAME_PICS [13] [5] = getImage (base, "0.png");
	GAME_PICS [10] [5] = getImage (base, "excellent.png");
	GAME_PICS [11] [5] = getImage (base, "good.png");
	GAME_PICS [12] [5] = getImage (base, "great.png");

	GAME_PICS [0] [6] = getImage (base, "MwalkL1.png");
	GAME_PICS [1] [6] = getImage (base, "MwalkL2.png");
	GAME_PICS [2] [6] = getImage (base, "MwalkL3.png");
	GAME_PICS [3] [6] = getImage (base, "MwalkL4.png");
	GAME_PICS [4] [6] = getImage (base, "MwalkL5.png");
	GAME_PICS [5] [6] = getImage (base, "MwalkL4.png");
	GAME_PICS [6] [6] = getImage (base, "MwalkL3.png");
	GAME_PICS [7] [6] = getImage (base, "MwalkL2.png");

	GAME_PICS [0] [7] = getImage (base, "Mscared1.png");
	GAME_PICS [1] [7] = getImage (base, "Mscared2.png");
	GAME_PICS [2] [7] = getImage (base, "Mscared3.png");
	GAME_PICS [3] [7] = getImage (base, "Mscared2.png");

	GAME_PICS [0] [8] = getImage (base, "MwalkU1.png");
	GAME_PICS [1] [8] = getImage (base, "MwalkU2.png");
	GAME_PICS [2] [8] = getImage (base, "MwalkU3.png");
	GAME_PICS [3] [8] = getImage (base, "MwalkU4.png");
	GAME_PICS [4] [8] = getImage (base, "MwalkU5.png");
	GAME_PICS [5] [8] = getImage (base, "MwalkU4.png");
	GAME_PICS [6] [8] = getImage (base, "MwalkU3.png");
	GAME_PICS [7] [8] = getImage (base, "MwalkU2.png");

	GAME_PICS [0] [9] = getImage (base, "barrel1.png");
	GAME_PICS [1] [9] = getImage (base, "barrel2.png");
	GAME_PICS [2] [9] = getImage (base, "barrel3.png");
	GAME_PICS [3] [9] = getImage (base, "barrel4.png");
	GAME_PICS [4] [9] = getImage (base, "barrel5.png");
	GAME_PICS [5] [9] = getImage (base, "barrel6.png");
	GAME_PICS [6] [9] = getImage (base, "barrel7.png");
	GAME_PICS [7] [9] = getImage (base, "barrel8.png");
	GAME_PICS [8] [9] = getImage (base, "barrel9.png");
	GAME_PICS [9] [9] = getImage (base, "barrel10.png");
	GAME_PICS [10] [9] = getImage (base, "barrel11.png");
	GAME_PICS [11] [9] = getImage (base, "barrel12.png");
	GAME_PICS [12] [9] = getImage (base, "barrel13.png");
	GAME_PICS [13] [9] = getImage (base, "barrel14.png");
	GAME_PICS [14] [9] = getImage (base, "barrel15.png");

	GAME_PICS [1] [10] = getImage (base, "grey.png");
	GAME_PICS [2] [10] = getImage (base, "purple.png");
	GAME_PICS [3] [10] = getImage (base, "teal.png");
	GAME_PICS [4] [10] = getImage (base, "blue.png");
	GAME_PICS [5] [10] = getImage (base, "pink.png");
	GAME_PICS [6] [10] = getImage (base, "green.png");
	GAME_PICS [7] [10] = getImage (base, "red.png");

	GAME_PICS [0] [11] = getImage (base, "marioitem1.png");
	GAME_PICS [1] [11] = getImage (base, "marioitem1.png");
	GAME_PICS [2] [11] = getImage (base, "marioitem1.png");
	GAME_PICS [3] [11] = getImage (base, "marioitem1.png");
	GAME_PICS [4] [11] = getImage (base, "marioitem1.png");
	GAME_PICS [5] [11] = getImage (base, "marioitem1.png");
	GAME_PICS [6] [11] = getImage (base, "marioitem1.png");
	GAME_PICS [7] [11] = getImage (base, "marioitem1.png");
	GAME_PICS [8] [11] = getImage (base, "marioitem1.png");
	GAME_PICS [9] [11] = getImage (base, "marioitem1.png");
	GAME_PICS [10] [11] = getImage (base, "marioitem2.png");
	GAME_PICS [11] [11] = getImage (base, "marioitem2.png");
	GAME_PICS [12] [11] = getImage (base, "marioitem2.png");
	GAME_PICS [13] [11] = getImage (base, "marioitem2.png");
	GAME_PICS [14] [11] = getImage (base, "marioitem2.png");
	GAME_PICS [15] [11] = getImage (base, "marioitem2.png");
	GAME_PICS [16] [11] = getImage (base, "marioitem2.png");
	GAME_PICS [17] [11] = getImage (base, "marioitem2.png");
	GAME_PICS [18] [11] = getImage (base, "marioitem2.png");
	GAME_PICS [19] [11] = getImage (base, "marioitem2.png");
	GAME_PICS [20] [11] = getImage (base, "marioitem3.png");
	GAME_PICS [21] [11] = getImage (base, "marioitem3.png");
	GAME_PICS [22] [11] = getImage (base, "marioitem3.png");
	GAME_PICS [23] [11] = getImage (base, "marioitem3.png");
	GAME_PICS [24] [11] = getImage (base, "marioitem3.png");
	GAME_PICS [25] [11] = getImage (base, "marioitem3.png");
	GAME_PICS [26] [11] = getImage (base, "marioitem3.png");
	GAME_PICS [27] [11] = getImage (base, "marioitem3.png");
	GAME_PICS [28] [11] = getImage (base, "marioitem3.png");
	GAME_PICS [29] [11] = getImage (base, "marioitem3.png");
	GAME_PICS [30] [11] = getImage (base, "marioitem4.png");
	GAME_PICS [31] [11] = getImage (base, "marioitem4.png");
	GAME_PICS [32] [11] = getImage (base, "marioitem4.png");
	GAME_PICS [33] [11] = getImage (base, "marioitem4.png");
	GAME_PICS [34] [11] = getImage (base, "marioitem4.png");
	GAME_PICS [35] [11] = getImage (base, "marioitem4.png");
	GAME_PICS [36] [11] = getImage (base, "marioitem4.png");
	GAME_PICS [37] [11] = getImage (base, "marioitem4.png");
	GAME_PICS [38] [11] = getImage (base, "marioitem4.png");
	GAME_PICS [39] [11] = getImage (base, "marioitem4.png");
	GAME_PICS [40] [11] = getImage (base, "marioitem5.png");
	GAME_PICS [41] [11] = getImage (base, "marioitem5.png");
	GAME_PICS [42] [11] = getImage (base, "marioitem5.png");
	GAME_PICS [43] [11] = getImage (base, "marioitem5.png");
	GAME_PICS [44] [11] = getImage (base, "marioitem5.png");
	GAME_PICS [45] [11] = getImage (base, "marioitem5.png");
	GAME_PICS [46] [11] = getImage (base, "marioitem5.png");
	GAME_PICS [47] [11] = getImage (base, "marioitem5.png");
	GAME_PICS [48] [11] = getImage (base, "marioitem5.png");
	GAME_PICS [49] [11] = getImage (base, "marioitem5.png");
	GAME_PICS [50] [11] = getImage (base, "marioitem6.png");
	GAME_PICS [51] [11] = getImage (base, "marioitem6.png");
	GAME_PICS [52] [11] = getImage (base, "marioitem6.png");
	GAME_PICS [53] [11] = getImage (base, "marioitem6.png");
	GAME_PICS [54] [11] = getImage (base, "marioitem6.png");
	GAME_PICS [55] [11] = getImage (base, "marioitem6.png");
	GAME_PICS [56] [11] = getImage (base, "marioitem6.png");
	GAME_PICS [57] [11] = getImage (base, "marioitem6.png");
	GAME_PICS [58] [11] = getImage (base, "marioitem6.png");
	GAME_PICS [59] [11] = getImage (base, "marioitem6.png");


	GAME_PICS [0] [12] = getImage (base, "bobomb1.png");
	GAME_PICS [1] [12] = getImage (base, "bobomb1.png");
	GAME_PICS [2] [12] = getImage (base, "bobomb2.png");
	GAME_PICS [3] [12] = getImage (base, "bobomb3.png");
	GAME_PICS [4] [12] = getImage (base, "bobomb4.png");
	GAME_PICS [5] [12] = getImage (base, "bobomb5.png");
	GAME_PICS [6] [12] = getImage (base, "bobomb6.png");
	GAME_PICS [7] [12] = getImage (base, "explosion.png");
	GAME_PICS [8] [12] = getImage (base, "spark.png");
